...
# test.c:15:     struct tt t1 = {12, 13};
	movl	$12, -16(%rbp)	#, t1.x
	movb	$13, -12(%rbp)	#, t1.c
# test.c:16:     struct tt t2 = t1;
	movq	-16(%rbp), %rax	# t1, tmp92
	movq	%rax, -8(%rbp)	# tmp92, t2
# test.c:17:     t2.x = 99;
	movl	$99, -8(%rbp)	#, t2.x
# test.c:18:     printf("%d, %d", t1.x, t1.c);
	movzbl	-12(%rbp), %eax	# t1.c, _1
	movsbl	%al, %edx	# _1, _2
	movl	-16(%rbp), %eax	# t1.x, _3
	movl	%eax, %esi	# _3,
	leaq	.LC0(%rip), %rdi	#,
	movl	$0, %eax	#,
	call	printf@PLT	#
